...
const connects: IConnect[] = [
  ...
  {
    label: "Twitter (X)",
    link: "https://x.com/SoumitraSaha100",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
    ...
    <section className="px-4">
      ...
      <div>
        ...
        <div className="flex items-center space-x-3">
          <div className="font-[500]">System Theme</div>
          <ModeToggle />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex items-center mt-4 space-x-3">
          {connects.map((connect) => (
            <div key={connect.label} className="flex items-center">
              <Tooltip>
                <TooltipTrigger>
                  <Link to={connect.link} target="_blank">
                    {connect.icon}
                  </Link>
                </TooltipTrigger>
                <TooltipContent className={cn("bg-white text-background-1")}>
                  <p>{connect.label}</p>
                </TooltipContent>
              </Tooltip>
            </div>
